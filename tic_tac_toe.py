...
player = 1            # to inialize first player
...
while True: 
    ...
    if total_moves == 9 or end_check == 1:
        break
    while True:       #input ffrom players
        if player == 1: # choose player
            p1_input = input('Pick a spot Player One. You are X :')
            ...
            p2_input = input('Pick a spot Player Two. You are O :')
